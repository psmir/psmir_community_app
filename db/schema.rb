...
ActiveRecord::Schema.define(:version => 20120312171817) do
  ...
  create_table "blogger_readers", :force => true do |t|
  ...
  add_index "blogger_readers", ["blogger_id"], :name => "index_blogger_readers_on_blogger_id"
  add_index "blogger_readers", ["reader_id"], :name => "index_blogger_readers_on_reader_id"
